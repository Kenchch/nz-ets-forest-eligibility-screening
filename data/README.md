...
topology, clip to the official boundary, explode multipart mapping units, remove
36 numerical clipping fragments below 1 m², assign stable `unit_id` values,
reproject to `EPSG:2193`, and write the four processed
